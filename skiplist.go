...
const (
	// DefaultMaxLevel Suitable for math.Floor(math.Pow(math.E, 18)) == 65659969 elements in list
...
func NewWithMaxLevel[T TKey](maxLevel int) *SkipList[T] {
